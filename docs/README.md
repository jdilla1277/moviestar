...
The CLI's built-in help is the authoritative command reference. Run
`moviestar --help`, then `moviestar COMMAND --help` or nested help such as
`moviestar scenes motion --help` before using an unfamiliar surface.
